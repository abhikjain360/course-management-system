 ...
 * @author kaka
 */
public class RemoveCourseAdmin extends javax.swing.JFrame {

    /**
     * Creates new form RemoveCourseAdmin
     */
    public RemoveCourseAdmin() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(RemoveCourseAdmin.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new RemoveCourseAdmin().setVisible(true);
            }
        });
    }
